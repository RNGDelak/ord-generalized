...
let notation = (() => {
    ...
    const Limit = [0,2] //compulsory: how the bounded ordinal in your system defined? Should be an valid ordinal input for above functions
    const DisplayName = ["normal", "CNF included"] //compulsory: add all your mode name here so the program can query them and display
    const ordinalTypes = [["Zero", "#808080"],["Successor Ordinal", "#d40000"],["Tower of ω", "#ffffff"],["Power of ω", "#ffd000"],["Limit Ordinal", "#ff8000"],]; //compulsory: for legends gui purposes so user can know colour correspond to class of ordinal 

    const Aliases = [["Veblen Ordinal", "0,2,4,5"], ["Buchholz Ordinal", "Limit"]] //important ordinal
