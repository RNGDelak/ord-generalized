...
### In future, i'd add some more notation, which including these
   ...
   * and all of the rest notation from following notation explorer
     ...
     * similelee-lyx's notation explorer: https://smilelee-lyx.github.io/ne-rewritten/
...
* **v2.21** — https://rngdelak.github.io/ord-generalized/versions/version%202.21/ <details open>
  * **Description:**
    ...
    * Added the ability to disable rendering of the number line independently from other UI elements.
    * Improved the notation-selection UI and preset organization.
    * Standardized ordinal classification colors across several existing notation libraries.
    * Improved the information copied by the position/zoom sharing function.
  ...
  * #### Added:
    * Old libs — already present in v2.20
      ...
      * **EcOCF: Extended version of cOCF** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FEcOCF.js
      * **EBO: Extended Buchholz OCF** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FEBO.js
      * **HPrSS: Hyper Primitive Sequence System** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FHPrSS.js
      * **LPrSS: Large Primitive Sequence System** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FLPrSS.js
      * **n-shifted-OCF** — https://rngdelak.github.io/ord-generalized/#href=Libs%2Fn-shifted-OCF.js
      * **TON: Taranovsky's Ordinal Notation** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FTON.js
    ...
    * Newly added in v2.21
      ...
      * **APS: Address Pair Sequence** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FAPS.js
      * **ATS: Address Trio Sequence** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FATS.js
      * **BHM: Bashicu Hyper Matrix** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FBHM.js
      * **BHSM: Bashicu Hyper Sudden Matrix** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FBHSM.js
      * **BLM: Bashicu Large Matrix** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FBLM.js
      * **BSM: Bashicu Sudden Matrix** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FBSM.js
      * **BwMN: Branching ω Mountain Notation** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FBwMN.js
      * **ESH: Extended Sequence Hydra** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FESH.js
      * **ESS: Extended Shifted Sequence** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FESS.js
      * **Eulerian** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FEulerian.js
      * **FSS: Fundamental Sequence System** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FFSS.js
      * **HH: Hyper Hydra** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FHH.js
      * **HHH: Hyper Hyper Hydra** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FHHH.js
      * **HS: Hyper Sequence** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FHS.js
      * **HSH: Hyper Sequence Hydra** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FHSH.js
      * **HSwY: Hierachical Strong / Ω-Y sequence** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FHSwY.js
      * **LMN: Lifting M-Notation** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FLMN.js
      * **LON: Lifting Omega Notation** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FLON.js
      * **MS: Matrix Sequence** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FMS.js
      * **OSSS: Orchestral Superiour Sequence System** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FOSSS.js
      * **PHPrSS: HPrSS but each element store its parent position(pointer)** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FPHPrSS.js
      * **PLPrSS: Pointer LPrSS** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FPLPrSS.js
      * **PMS: Pointer Matrix Sequence** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FPMS.js
      * **PPS: Pointer Pair Sequence** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FPPS.js
      * **PS: Pair Sequence** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FPS.js
      * **PTS: Pointer Trio Sequence** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FPTS.js
      * **SFSS: Strong Fundamental Sequence System** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FSFSS.js
      * **SH: Sequence Hydra** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FSH.js
      * **SSH: Shifted Sequence Hydra** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FSSH.js
      * **TS: Trio Sequence** — https://rngdelak.github.io/ord-generalized/#href=Libs%2FTS.js
    ...
    * Added `sampleMaxWidth`.
    * Added `sampleTransform`.
    ...
    * Added keyboard shortcut **`2`** for cycling sample text alignment:
      ...
      * center
      * right
    * Added **Space + Arrow Key** toggling for persistent movement.
    ...
    * Added ω-Y Sequence to the official notation selection.
    * Added descriptions/full names to the preset notation selector.
    * Added extra experimental notation entries to the source as prepared/commented options for future activation.
  ...
  * **Changes:**
    ...
    * Changed BMS `DisplayName` from:
      ...
      * `0Y`
      * `2 shifted-OCF`
    * Changed BMS's `display()` logic so each representation is selected explicitly by mode.
    * Changed the BMS shifted-OCF condition so it is only used for values below its specified threshold.
    ...
    * Updated sample rendering to apply:
      ...
      * text alignment
    * Updated keyboard handling so **Ctrl+S** is no longer treated as the ordinary depth-control `S` shortcut.
    ...
    * Standardized successor/limit classification colors in several notation libraries:
      ...
      * `LPrSS.js`
      * `n-shifted-OCF.js`
    * Changed the standard successor color from `#d40000` to `#a00000`.
    * Changed the standard limit color from `#ff8000` to `#ffA000`.
    * Updated several power-of-ω colors from the older yellow/orange variants to `#ffff00`.
  ...
  * **Fixes:**
    ...
    * Improved BMS matrix processing with normalization, ancestor tracking, and trailing-zero handling required by the new representations.
    * Improved keyboard interaction so persistent arrow-key movement can be toggled without requiring the key to remain physically pressed.
    * Improved sample-text positioning and alignment control.
    * Improved the information copied for sharing a viewport by including the notation and relevant display configuration.
    * Improved the notation preset UI by separating currently promoted/official systems from experimental systems.
...
And in past year, i tried to firgure out myself , and thats it, i written a [document](https://github.com/RNGDelak/ord-limbms/blob/main/README.md), and making 3 transfinite number line which is [ord-w](https://rngdelak.github.io/ord-w/), [ord-ww](https://rngdelak.github.io/ord-ww/) and [ord-limbms](https://rngdelak.github.io/ord-limbms/) (even a scratch version, which neverrrr to be complete [lol](https://scratch.mit.edu/projects/1247085717/)) with vital help from [@solarzone1010](https://solarzone1010.github.io/).
...
Now I can finally take out the plan I wrote four months ago for this project, which might never have happened without his source code...
